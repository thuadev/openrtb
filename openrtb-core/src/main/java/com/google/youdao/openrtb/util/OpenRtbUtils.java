...
import com.google.youdao.openrtb.OpenRtb.BidRequest.User.Gender;
...
import com.google.youdao.openrtb.OpenRtb.BidResponse.SeatBidOrBuilder;
import com.google.youdao.openrtb.OpenRtb.ContentCategory;
...
public final class OpenRtbUtils {
   ...
   *
   * @see #seatBid(com.google.youdao.openrtb.OpenRtb.BidResponse.Builder)
   ...
   *     May have bids from multiple seats, grouped by seat
   * @deprecated Use {@link #bidsWith(com.google.youdao.openrtb.OpenRtb.BidResponse.Builder, String, Predicate)}
  ...
  /**
   * @deprecated Use {@link #removeBids(com.google.youdao.openrtb.OpenRtb.BidResponse.Builder, Predicate)}
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #removeBids(com.google.youdao.openrtb.OpenRtb.BidResponse.Builder, String, Predicate)}
   */
  @Deprecated
   ...
   * {@link com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner}s
   * @param video {@code true} to include impressions with
   * {@link com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video}s
   * @param nativ {@code true} to include impressions with
   * {@link com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Native}s
