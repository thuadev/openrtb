...
package com.google.youdao.openrtb.json;

import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.endArray;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.endObject;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.getCurrentName;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.getDoubleValue;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.getIntBoolValue;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.peekStruct;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.readCsvString;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.startArray;
import static com.google.youdao.openrtb.json.OpenRtbJsonUtils.startObject;

import com.google.common.io.CharSource;
import com.google.common.io.Closeables;
import com.google.youdao.openrtb.OpenRtb.BidRequest;
import com.google.youdao.openrtb.OpenRtb.BidRequest.App;
import com.google.youdao.openrtb.OpenRtb.BidRequest.AuctionType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Content;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Content.ContentContext;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Content.QAGMediaRating;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Content.VideoQuality;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Data;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Data.Segment;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Device;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Device.ConnectionType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Device.DeviceType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Geo;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Geo.LocationType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.APIFramework;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.AdPosition;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner.BannerAdType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner.ExpandableDirection;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Native;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Pmp;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Pmp.Deal;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.CompanionAd;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.ContentDeliveryMethod;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VASTCompanionType;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoBidResponseProtocol;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoLinearity;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoPlaybackMethod;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Producer;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Publisher;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Regs;
import com.google.youdao.openrtb.OpenRtb.BidRequest.Site;
import com.google.youdao.openrtb.OpenRtb.BidRequest.User;
import com.google.youdao.openrtb.OpenRtb.BidResponse;
import com.google.youdao.openrtb.OpenRtb.BidResponse.NoBidReason;
import com.google.youdao.openrtb.OpenRtb.BidResponse.SeatBid;
...
import com.google.youdao.openrtb.util.OpenRtbUtils;
import com.google.youdao.openrtb.util.ProtoUtils;
