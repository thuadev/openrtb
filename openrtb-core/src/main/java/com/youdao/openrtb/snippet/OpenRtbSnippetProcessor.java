...
import com.youdao.openrtb.OpenRtb.BidRequest.ImpOrBuilder;
import com.youdao.openrtb.OpenRtb.BidResponse.SeatBid;
import com.youdao.openrtb.OpenRtb.BidResponse.SeatBid.Bid;
import com.youdao.openrtb.OpenRtb.BidResponse.SeatBid.BidOrBuilder;
...
public class OpenRtbSnippetProcessor extends SnippetProcessor {
  public static final OpenRtbSnippetProcessor ORTB_NULL = new OpenRtbSnippetProcessor() {
    @Override public String process(SnippetProcessorContext ctx, String snippet) {
      return NULL.process(ctx, snippet);
    }};
