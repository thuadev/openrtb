...
import com.youdao.openrtb.OpenRtb.NativeRequest.AdUnitId;
import com.youdao.openrtb.OpenRtb.NativeRequest.Asset.Data.DataAssetType;
import com.youdao.openrtb.OpenRtb.NativeRequest.Asset.Image.ImageAssetType;
import com.youdao.openrtb.OpenRtb.NativeRequest.LayoutId;
  ...
  protected void readReqAssetField(
    ...
    switch (fieldName) {
      case "id":
        ...
        break;
      case "required":
        asset.setRequired(OpenRtbJsonUtils.getIntBoolValue(par));
        break;
      case "title":
