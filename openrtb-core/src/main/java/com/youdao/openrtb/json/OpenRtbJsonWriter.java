...
public class OpenRtbJsonWriter extends AbstractOpenRtbJsonWriter {
  ...
  protected void writeBidRequestFields(BidRequest req, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("bcat", req.getBcatList(), gen);
  ...
  protected void writeBannerFields(Banner banner, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeEnums("btype", banner.getBtypeList(), gen);
    OpenRtbJsonUtils.writeEnums("battr", banner.getBattrList(), gen);
    if (banner.hasPos()) {
    ...
    OpenRtbJsonUtils.writeEnums("expdir", banner.getExpdirList(), gen);
    OpenRtbJsonUtils.writeEnums("api", banner.getApiList(), gen);
  }
  ...
  protected void writeVideoFields(Video video, JsonGenerator gen) throws IOException {
    ...
    if (checkRequired(video.getProtocolsCount())) {
      OpenRtbJsonUtils.writeEnums("protocols", video.getProtocolsList(), gen);
    }
    if (video.hasW()) {
    ...
    OpenRtbJsonUtils.writeEnums("battr", video.getBattrList(), gen);
    ...
    OpenRtbJsonUtils.writeEnums("playbackmethod", video.getPlaybackmethodList(), gen);
    OpenRtbJsonUtils.writeEnums("delivery", video.getDeliveryList(), gen);
    if (video.hasPos()) {
    ...
    OpenRtbJsonUtils.writeEnums("api", video.getApiList(), gen);
    OpenRtbJsonUtils.writeEnums("companiontype", video.getCompaniontypeList(), gen);
  }
  ...
  protected void writeNativeFields(Native nativ, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeEnums("api", nativ.getApiList(), gen);
    OpenRtbJsonUtils.writeEnums("battr", nativ.getBattrList(), gen);
  }
  ...
  protected void writeSiteFields(Site site, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", site.getCatList(), gen);
    OpenRtbJsonUtils.writeContentCategories("sectioncat", site.getSectioncatList(), gen);
    OpenRtbJsonUtils.writeContentCategories("pagecat", site.getPagecatList(), gen);
    if (site.hasPage()) {
  ...
  protected void writeAppFields(App app, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", app.getCatList(), gen);
    OpenRtbJsonUtils.writeContentCategories("sectioncat", app.getSectioncatList(), gen);
    OpenRtbJsonUtils.writeContentCategories("pagecat", app.getPagecatList(), gen);
    if (app.hasVer()) {
  ...
  protected void writeContentFields(Content content, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", content.getCatList(), gen);
  ...
  protected void writeProducerFields(Producer producer, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", producer.getCatList(), gen);
  ...
  protected void writePublisherFields(Publisher publisher, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", publisher.getCatList(), gen);
  ...
  protected void writeBidFields(Bid bid, JsonGenerator gen) throws IOException {
    ...
    OpenRtbJsonUtils.writeContentCategories("cat", bid.getCatList(), gen);
    OpenRtbJsonUtils.writeEnums("attr", bid.getAttrList(), gen);
    if (bid.hasDealid()) {
