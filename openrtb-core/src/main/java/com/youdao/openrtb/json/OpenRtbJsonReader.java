...
package com.youdao.openrtb.json;

import static com.youdao.openrtb.json.OpenRtbJsonUtils.endArray;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.endObject;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.getCurrentName;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.getDoubleValue;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.getIntBoolValue;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.peekStruct;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.readCsvString;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.startArray;
import static com.youdao.openrtb.json.OpenRtbJsonUtils.startObject;

import com.google.common.io.CharSource;
import com.google.common.io.Closeables;
import com.youdao.openrtb.OpenRtb.BidRequest;
import com.youdao.openrtb.OpenRtb.BidRequest.App;
import com.youdao.openrtb.OpenRtb.BidRequest.AuctionType;
import com.youdao.openrtb.OpenRtb.BidRequest.Content;
import com.youdao.openrtb.OpenRtb.BidRequest.Content.ContentContext;
import com.youdao.openrtb.OpenRtb.BidRequest.Content.QAGMediaRating;
import com.youdao.openrtb.OpenRtb.BidRequest.Content.VideoQuality;
import com.youdao.openrtb.OpenRtb.BidRequest.Data;
import com.youdao.openrtb.OpenRtb.BidRequest.Data.Segment;
import com.youdao.openrtb.OpenRtb.BidRequest.Device;
import com.youdao.openrtb.OpenRtb.BidRequest.Device.ConnectionType;
import com.youdao.openrtb.OpenRtb.BidRequest.Device.DeviceType;
import com.youdao.openrtb.OpenRtb.BidRequest.Geo;
import com.youdao.openrtb.OpenRtb.BidRequest.Geo.LocationType;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.APIFramework;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.AdPosition;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner.BannerAdType;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Banner.ExpandableDirection;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Native;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Pmp;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Pmp.Deal;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.CompanionAd;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.ContentDeliveryMethod;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VASTCompanionType;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoBidResponseProtocol;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoLinearity;
import com.youdao.openrtb.OpenRtb.BidRequest.Imp.Video.VideoPlaybackMethod;
import com.youdao.openrtb.OpenRtb.BidRequest.Producer;
import com.youdao.openrtb.OpenRtb.BidRequest.Publisher;
import com.youdao.openrtb.OpenRtb.BidRequest.Regs;
import com.youdao.openrtb.OpenRtb.BidRequest.Site;
import com.youdao.openrtb.OpenRtb.BidRequest.User;
import com.youdao.openrtb.OpenRtb.BidResponse;
import com.youdao.openrtb.OpenRtb.BidResponse.NoBidReason;
import com.youdao.openrtb.OpenRtb.BidResponse.SeatBid;
import com.youdao.openrtb.OpenRtb.BidResponse.SeatBid.Bid;
import com.youdao.openrtb.OpenRtb.CreativeAttribute;
import com.youdao.openrtb.util.OpenRtbUtils;
